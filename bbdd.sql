...
alter table videojuegos add foreign key (id_genero) references genero(id);
alter table videojuegos add foreign key (id_distribuidor) references distribuidor(id);
...
alter table es_desarrollado add foreign key (id_videojuego) references videojuegos(id);
alter table es_desarrollado add foreign key (id_desarrolladora) references desarrolladora(id);
...
alter table formato_juego add foreign key (id_videojuego) references videojuegos(id);
alter table formato_juego add foreign key (id_formato) references formato(id);
...
alter table compra add foreign key (id_videojuego) references videojuegos(id);
alter table compra add foreign key (id_cliente) references clientes(id);
alter table compra add foreign key (id_local) references local_fisico(id);
...
alter table almacenar add foreign key (id_local) references local_fisico(id);
alter table almacenar add foreign key (id_videojuego) references videojuegos(id);
