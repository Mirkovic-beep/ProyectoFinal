			...
			<div class="container">
				...
				<div class="right-section pull-right">
					<a href="cart.jsp" class="cart"><i class="icon-cart"></i>
						Carrito Vacio</a> <a href="#" class="login-button">Iniciar
						sesion/Registro</a>
				</div>
				<!-- .right-section -->
				...
				<div class="breadcrumbs">
					<div class="container">
						<a href="index.jsp">Home</a> <span>Sobre nosotros</span>
					</div>
				</div>
			</div>
			<!-- .container -->
		...
		<main class="main-content">
			<div class="container">
				<div class="page">
					...
					<h2 class="title-aboutus">NelsON Games Reinventando el futuro
						del alquiler de videojuegos</h2>
					<p>En NelsON games nos preocupamos por nuestros clientes,
						aseguramos una entrega del producto en perfecto estado, de forma
						rápida y eficaz. Disponemos de muchos convenios con empresas
						creadoras y distribuidoras de videojuegos de todas las categorías.</p>
					<br>
					...
					<ol>
						...
						<li>No testeamos nuestros productos con animales solo con
							jugadores de League of Legends</li>
					...
					<div class="row">
						...
						<div class="col-md-3">
							<div class="feature">
								...
								<h3 class="feature-title">Envios internacionales</h3>
							</div>
							<!-- .feature -->
						</div>
						<!-- .column -->
