...
%>
<%ArrayList<Videojuego> juegos = cotroladorBD.dameJuegosConsola("Xbox");%>
	...
	<div id="site-content">
		<div class="site-header">
			...
			<div class="breadcrumbs">
				<div class="container">
					<a href="index.jsp">Home</a> <span>Xbox</span>
				</div>
			</div>
					...
					<div class="product">
						<div class="inner-product">
							<div class="figure-image">
								<a href="single.jsp?id=<%=juegos.get(i).getId()%>"><img
									src="images/<%=juegos.get(i).getNombre()%>.jpg" alt="Game 1"></a>
							</div>
							<h3 class="product-title">
								<a href="#"><%=juegos.get(i).getNombre().toUpperCase()%></a>
							</h3>
							<small class="price"><%=juegos.get(i).getPrecio()%> €</small> <a
								href="cart.jsp" class="button">Añadir al carrito</a> <a
								href="single.jsp?id=<%=juegos.get(i).getId()%>"
