			...
			<main class="main-content">
				<div class="container">
					...
					<div class="row gtr-50">
								<h3>Modificar formato de videojuegos</h3>
						
						<%for(int i=0;i<juegos.size();i++){ %>
								<div class="product">
									<div class="inner-product">
										<div class="figure-image">
											<a href="Formato-videojuegoform.jsp?id_videojuego=<%=juegos.get(i).getId()%>"><img src="../../images/<%=juegos.get(i).getNombre()%>.jpg"  width="100" height="200" alt="Game 1"></a>
										</div>
