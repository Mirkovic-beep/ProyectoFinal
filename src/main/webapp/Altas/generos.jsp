					...
					<div class="page">
						...
						<div class="product-list">
							...
							<section>
								...
								<form action="../operaciones_alu.jsp?accion=AltaGenero" method="post">
									<div>
										<div class="">
											<input type="text" name="nombre" id="nombre" required placeholder="Nombre genero" required style="width:163px"/>
										</div>	
										<br>
										<div class="">
											<input type="text" name="dificultad" id="dificultad" required placeholder="Dificultad" style="width:163px"/>
										</div>
										<br>
