...
<body>
		...
		<div class="site-header">
			...
			<div class="breadcrumbs">
				<div class="container">
					...
					<a href="../altasextra.jsp">Altas-extra</a> <span>Compra</span>
				</div>
				...
				<div class="page">
					...
					<div class="product-list">
						...
						<div class="login-box">
							...
							<form
								action="../../operaciones_alu.jsp?accion=AltaCompraVideojuegoLocal"
								method="post">
								...
								<div class="mm-dropdown">
									<div class="textfirst">Selecciona juego</div>
									<ul class="scrollable-menu">
										<%
										for (int i = 0; i < juegos.size(); i++) {
										%>
										<li class="input-option"
											data-value="<%=juegos.get(i).getNombre()%>"><img
											src="../../images/<%=juegos.get(i).getNombre()%>.jpg"
											class="center" width="100" height="100">
											<h3 id="centro"><%=juegos.get(i).getNombre()%></h3> <input
											type="hidden" class="option" name="nombre_videojuego"
											value="<%=juegos.get(i).getNombre()%>" /></li>
										<%
										}
										%>
									</ul>
								...
								<div class="mm-dropdown">
									<div class="textfirst1">Selecciona cliente</div>
									<ul class="scrollable-menu">
										<%
										for (int i = 0; i < clientes.size(); i++) {
										%>
										<li class="input-option1"
											data-value="<%=clientes.get(i).getNombre()%>"><img
											src="../../images/<%=clientes.get(i).getNombre()%>.jpg"
											class="center" width="100" height="100">
											<h3 id="centro"><%=clientes.get(i).getNombre()%></h3> <input
											type="hidden" class="option1" name="nombre_cliente"
											value="<%=clientes.get(i).getNombre()%>" /></li>
										<%
										}
										%>
									</ul>
								...
								<div class="user-box">
									<input type="text" name="fecha_compra" id="fecha_compra"
										required placeholder="Fecha compra" />
								</div>
								<br>

								<div class="mm-dropdown">
									<div class="textfirst2">Selecciona Local</div>
									<ul class="scrollable-menu">
										<%
										for (int i = 0; i < locales.size(); i++) {
										%>
										<li class="input-option2"
											data-value="<%=locales.get(i).getNombre()%>"><img
											src="../../images/<%=locales.get(i).getNombre()%>.jpg"
											class="center" width="100" height="100">
											<h3 id="centro"><%=locales.get(i).getNombre()%></h3> <input
											type="hidden" class="option2" name="nombre_local"
											value="<%=locales.get(i).getNombre()%>" /></li>
										<%
										}
										%>
									</ul>
	...
	<script src="../../js/dropdowns3.js"></script>
