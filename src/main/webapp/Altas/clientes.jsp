		...
		<div class="site-header">
			...
			<div class="breadcrumbs">
				<div class="container">
					...
					<a href="../altas.jsp">Altas</a> <span>Alta cliente</span>
				</div>
			</div>
			...
			<div class="page">
				...
				<div class="product-list">
					...
					<div class="login-box">
						...
						<form action="../operaciones_alu.jsp?accion=AltaCliente"
							method="post">
							<div>
								<div class="user-box">
								...
								<div class="user-box">
									<input type="text" name="apellidos_cliente"
										id="apellidos_cliente" required
										placeholder="Apellidos del cliente" />
								</div>
								<div class="user-box">
									<input type="text" name="dni_cliente" id="dni_cliente" required
										placeholder="Dni cliente formato 00000000A" />
								</div>
