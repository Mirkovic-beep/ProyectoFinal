				...
				<div class="container">
					...
					<div class="main-navigation">
						...
						<ul class="menu">
							...
							<li class="menu-item"><a href="Extras/Desarrolladora-videojuegolist.jsp">Desarrolladora-Videojuego</a></li>
							<li class="menu-item"><a href="Extras/Local-videojuegolist.jsp">Local-Videojuego</a></li>
							<li class="menu-item"><a href="Extras/Formato-videojuegolist.jsp">Formato-Videojuego</a></li>
							<li class="menu-item"><a href="Extras/compralist.jsp">Compra</a></li>
						</ul> <!-- .menu -->
				...
				<div class="container">
					<div class="page">
						...
						<div class="product-list">
							...
							<section>
							<header>
								<h2 class="section-title">Menu Bajas-Extra</h2>
							</header>
		
							<div class="product-list">
							
								<p> En el menú superior encontrarás las posibles bajas entre uniones de tablas</p>
