		...
		<div class="site-header">
			...
			<div class="breadcrumbs">
				<div class="container">
					...
					<a href="../bajas.jsp">Bajas</a> <span>Distribuidores</span>
				</div>
			</div>
						...
						<div class="product">
							<div class="inner-product">
								<div class="figure-image">
									<a
										href="../operaciones_baja.jsp?accion=BajaDistribuidor&id_distribuidor=<%=distribuidores.get(i).getId()%>"><img
										src="../images/<%=distribuidores.get(i).getNombre()%>.png"
										width="100" height="200" alt="Game 1"></a>
								</div>
								<h3 class="product-title">
									<a href="#"><%=distribuidores.get(i).getNombre().toUpperCase()%></a>
								</h3>
