	...
	<body>
		...
		<div id="site-content">
			...
			<main class="main-content">
				...
				<form action="../operaciones_baja.jsp?accion=BajaDistribuidor" method="post">
					<div class="row gtr-50">
					
							<section>		
								<h3>Baja Distribuidor</h3>
								
						<div class="">
							<div class="mm-dropdown">
								<div class="textfirst">Selecciona Distribuidor</div>
								<ul class="scrollable-menu">
									<%for (int i=0;i<distribuidores.size();i++){%>
									<li class="input-option" data-value="<%=distribuidores.get(i).getId()%>">
									<img src="../images/<%=distribuidores.get(i).getNombre() %>.png" alt="Girl in a jacket" width="500" height="600">
									<h3><%=distribuidores.get(i).getNombre()%></h3>
									<input type="hidden" class="option" name="id_distribuidor" value="<%=distribuidores.get(i).getId()%>"/>
									</li>
									<%} %>
									</ul>
								</div>
