	...
	<body>
		...
		<div id="site-content">
			...
			<main class="main-content">
				...
				<form action="../operaciones_baja.jsp?accion=BajaFormato" method="post">
						...
						<div class="">
							<div class="mm-dropdown">
								...
								<ul class="scrollable-menu">
									...
									<img src="../images/<%=formatos.get(i).getNombre() %>.jpg" alt="Girl in a jacket" width="500" height="600">
									<h3><%=formatos.get(i).getNombre()%></h3>
