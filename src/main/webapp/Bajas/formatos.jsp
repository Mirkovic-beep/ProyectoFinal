								...
								<div class="product">
									<div class="inner-product">
										<div class="figure-image">
											<a href="../operaciones_baja.jsp?accion=BajaFormato&id_formato=<%=formatos.get(i).getId()%>"><img src="../images/<%=formatos.get(i).getNombre()%>.jpg"  width="100" height="200" alt="Game 1"></a>
										</div>
