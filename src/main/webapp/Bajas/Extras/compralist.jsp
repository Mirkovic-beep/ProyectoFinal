...
<%ArrayList<Compra> compra= controladorBD.dameCompra();%>
			...
			<main class="main-content">
				<div class="container">
					...
					<div class="row gtr-50">
								<h3>Baja compra de videojuego</h3>
								
								<%for(int i=0;i<compra.size();i++){ %>
								<div class="product">
									<div class="inner-product">
										<div class="figure-image">
											<a href="../../operaciones_baja.jsp?accion=BajaCompra&id_videojuego=<%=compra.get(i).getId_videojuego()%>&id_cliente=<%=compra.get(i).getId_cliente()%>&id_local=<%=compra.get(i).getId_local()%>"><img src="../../images/<%=controladorBD.dameNombreVideojuego(compra.get(i).getId_videojuego()) %>.jpg" class="center" width="500" height="600">
									<img src="../../images/<%=controladorBD.dameNombreCliente(compra.get(i).getId_cliente())%>.jpg" class="center" width="500" height="600"><img src="../../images/<%=controladorBD.dameNombreLocal(compra.get(i).getId_local())%>.jpg" class="center" width="500" height="600"></a>
									
										</div>
									<h3 class="product-title"><%=controladorBD.dameNombreCliente(compra.get(i).getId_cliente())%> - <%=controladorBD.dameNombreVideojuego(compra.get(i).getId_videojuego())%> - <%=controladorBD.dameNombreLocal(compra.get(i).getId_local())%></h3>
