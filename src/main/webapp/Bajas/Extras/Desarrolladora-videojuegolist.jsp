...
<%ArrayList<Desarrollo> desarrollo = controladorBD.dameDesarrolladora_videojuego();%>
				...
				<div class="container">
					...
					<div class="breadcrumbs">
						<div class="container">
							...
							<span>Videojuegos-Desarrolladora</span>
						</div>
					</div>
			...
			<main class="main-content">
				<div class="container">
					...
					<div class="row gtr-50">
								<h3>Baja desarrolladora de videojuego</h3>
								
								<%for(int i=0;i<desarrollo.size();i++){ %>
								<div class="product">
									<div class="inner-product">
										<div class="figure-image">
											<a href="../../operaciones_baja.jsp?accion=BajaDesarrolladoraVideojuego&id_videojuego=<%=desarrollo.get(i).getId_videojeugo()%>&id_desarrolladora=<%=desarrollo.get(i).getId_desarrolladora()%>"><img src="../../images/<%=controladorBD.dameNombreVideojuego(desarrollo.get(i).getId_videojeugo()) %>.jpg" class="center" width="500" height="600">
									<img src="../../images/<%=controladorBD.dameNombreDesarrolladora(desarrollo.get(i).getId_desarrolladora())%>.png" class="center" width="500" height="600"></a>
										</div>
									<h3 class="product-title"><%=controladorBD.dameNombreDesarrolladora(desarrollo.get(i).getId_desarrolladora())%> - <%=controladorBD.dameNombreVideojuego(desarrollo.get(i).getId_videojeugo())%></h3>
