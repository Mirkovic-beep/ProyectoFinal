...
<%ArrayList<Almacenar> almacenar = controladorBD.dameLocal_videojuego();%>
			...
			<main class="main-content">
				<div class="container">
					...
					<div class="row gtr-50">
								...
								<h3>Baja Videojuego-local</h3>
								
								<%for(int i=0;i<almacenar.size();i++){ %>
								<div class="product">
									<div class="inner-product">
										<div class="figure-image">
											<a href="../../operaciones_baja.jsp?accion=BajaLocalVideojuego&id_videojuego=<%=almacenar.get(i).getId_videojuego()%>&id_local=<%=almacenar.get(i).getId_local()%>"><img src="../../images/<%=controladorBD.dameNombreVideojuego(almacenar.get(i).getId_videojuego()) %>.jpg" class="center" width="500" height="600">
									<img src="../../images/<%=controladorBD.dameNombreLocal(almacenar.get(i).getId_local())%>.jpg" class="center" width="500" height="600"></a>
										</div>
									<h3 class="product-title"><%=controladorBD.dameNombreLocal(almacenar.get(i).getId_local())%> - <%=controladorBD.dameNombreVideojuego(almacenar.get(i).getId_videojuego())%></h3>
