								...
								<div class="product">
									<div class="inner-product">
										<div class="figure-image">
											<a href="../operaciones_baja.jsp?accion=BajaCliente&id_cliente=<%=clientes.get(i).getId()%>"><img src="../images/<%=clientes.get(i).getNombre()%>.jpg"  width="100" height="200" alt="Game 1"></a>
										</div>
