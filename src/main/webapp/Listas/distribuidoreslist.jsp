								...
								<div class="product">
									<div class="inner-product">
										<div class="figure-image">
											<a href="distribuidorform.jsp?id_distribuidor=<%=distribuidores.get(i).getId() %>"><img src="../images/<%=distribuidores.get(i).getNombre()%>.png"  width="100" height="200" alt="Game 1"></a>
										</div>
										<h3 class="product-title"><a href="#"><%=distribuidores.get(i).getNombre().toUpperCase() %></a></h3>
										<br>
										<small class="price"><%=distribuidores.get(i).getAfiliacion() %></small>
										<small class="price"><%=distribuidores.get(i).getSede() %></small>
