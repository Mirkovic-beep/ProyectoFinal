		...
		<div id="site-content">
			...
			<main class="main-content">
				<div class="container">
					...
					<h3>Uniones local-videojuego</h3>
								...
								<div class="product">
									<div class="inner-product">
										<div class="figure-image">
											<img src="../../images/<%=controladorBD.dameNombreVideojuego(formatos.get(i).getId_videojuego()) %>.jpg" class="center" width="500" height="600">
									<img src="../../images/<%=controladorBD.dameNombreFormato(formatos.get(i).getId_formato())%>.jpg" class="center" width="500" height="600">
										</div>
