...
<%ArrayList<Videojuego> juegos = controladorBD.dameVideojuegos();%>
				...
				<div class="container">
					...
					<div class="breadcrumbs">
						<div class="container">
							...
							<a href="../modificacionesextra.jsp">Listas extra</a>
							<span>Compras</span>
						</div>
					</div>
								...
								<div class="product">
									<div class="inner-product">
										<div class="figure-image">
											<img src="../../images/<%=controladorBD.dameNombreVideojuego(compra.get(i).getId_videojuego()) %>.jpg" class="center" width="500" height="600">
									<img src="../../images/<%=controladorBD.dameNombreCliente(compra.get(i).getId_cliente())%>.jpg" class="center" width="500" height="600"><img src="../../images/<%=controladorBD.dameNombreLocal(compra.get(i).getId_local())%>.jpg" class="center" width="500" height="600">
