		...
		<div id="site-content">
			...
			<main class="main-content">
				<div class="container">
					...
					<h3>Uniones formato-videojuego</h3>
								...
								<div class="product">
									<div class="inner-product">
										<div class="figure-image">
											<img src="../../images/<%=controladorBD.dameNombreVideojuego(desarrollo.get(i).getId_videojeugo()) %>.jpg" class="center" width="500" height="600">
									<img src="../../images/<%=controladorBD.dameNombreDesarrolladora(desarrollo.get(i).getId_desarrolladora())%>.png" class="center" width="500" height="600">
										</div>
