		...
		<div id="site-content">
			...
			<main class="main-content">
				<div class="container">
					...
					<h3>Desarrolladora-videojuego </h3>
								...
								<div class="product">
									<div class="inner-product">
										<div class="figure-image">
											<img src="../../images/<%=controladorBD.dameNombreVideojuego(almacenar.get(i).getId_videojuego()) %>.jpg" class="center" width="500" height="600">
									<img src="../../images/<%=controladorBD.dameNombreLocal(almacenar.get(i).getId_local())%>.jpg" class="center" width="500" height="600">
										</div>
