	...
	<body>
		...
		<div id="site-content">
			...
			<main class="main-content">
				...
				<form action="clienteform.jsp" method="post">
								...
								<div class="product">
									<div class="inner-product">
										<div class="figure-image">
											<a href="clienteform.jsp?id_cliente=<%=clientes.get(i).getId() %>"><img src="../images/<%=clientes.get(i).getNombre()%>.jpg" alt="Game 1"></a>
										</div>
